...
public class AuthenticationFilter extends ZuulFilter {
	...
	private UserInfo isAuthTokenValid() {
		...
		try {
			restExchange = restTemplate.exchange("http://authenticationservice/v1/validate/{token}", HttpMethod.GET,
	...
	public Object run() {
		...
		// If we are dealing with a call to the authentication service, let the call go
